...
function Course() {
  ...
  return (
    <div className="bg-gray-300 w-full h-screen overflow-scroll pb-10 ">
      {console.log(course)}
      ...
      <div
            ...
            className={` cursor-pointer  h-8 ${Show==='CourseInfo'?"text-black bg-white":""} text-center`}
          >
            Course Info
          </div>
          <div
      ...
      </div>
  {
            ...
            <div className=" my-12 ">
              ...
              <div className=" grid grid-cols-2">
                <div className=" mx-14 my-5 text-xl">
                  ...
                  <div className=" py-4 ">Instructor</div>
                  <div className="  font-bold text-center mr-2  ">
                    <div className=" w-36 text-center  h-fit rounded-2xl grid gap-3 text-xs  py-2">
                        {val.instructor.map((item, ind) => {
                          return <div className="bg-gray-300 py-3 text-center px-5  rounded-2xl">{item.name}</div>;
                        })}
                    </div>
                  </div>
    ...
    <div className="flex flex-col mr-3">
      ...
      <div className="bg-white my-5 h-full  rounded-2xl">
        <div className="font-semibold text-center text-2xl py-5 capitalize underline ">About this field</div>
        {course.map((val, i) => {
          return (
            <div>
              {val.description ? (
                <div
                  ...
                  className="line-clamp-5 text-base px-2 font-normal  "
                />
              ) : (
                <div className="line-clamp-3 text-sm   font-normal px-2">
